...
func (*Metadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_2e59a1c5af4f6586, []int{0}
}
...
func (*Consenter) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_2e59a1c5af4f6586, []int{1}
}
...
func (*Options) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_2e59a1c5af4f6586, []int{2}
}
...
func init() {
	proto.RegisterFile("orderer/etcdraft/configuration.proto", fileDescriptor_configuration_2e59a1c5af4f6586)
}

var fileDescriptor_configuration_2e59a1c5af4f6586 = []byte{
