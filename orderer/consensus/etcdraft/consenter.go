...
func (c *Consenter) HandleChain(support consensus.ConsenterSupport, metadata *common.Metadata) (consensus.Chain, error) {
	...
	membership, err := c.consentersMembership(metadata, m)

	id, err := c.detectSelfID(membership.Consenters)
	if err != nil {
...
func (c *Consenter) consentersMembership(blockMetadata *common.Metadata, configMetadata *etcdraft.Metadata) (*etcdraft.RaftMetadata, error) {
